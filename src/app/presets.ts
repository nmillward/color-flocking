...
export const PRESETS: Preset[] = [
  ...
  },
  {
    id: 'honeycomb',
    name: 'Honeycomb',
    description: 'A hexagonal grid: every cell flocks with six neighbors instead of eight.',
    params: {
      colorSpace: 'oklab',
      grid: 'hex',
      cellShape: 'hexagon',
  ...
  },
  {
    id: 'halftone',
    name: 'Halftone',
    description: 'Neon dots on black, drifting like a printed screen come loose.',
    params: {
      colorSpace: 'oklab',
      cellShape: 'circle',
      cellSize: 14,
    ...
    seed: { kind: 'gradient', paletteId: 'neon-night', imageId: null },
  },
  {
    id: 'rain',
    name: 'Rain',
    description: 'Tall, narrow cells turn the flock into falling streaks of green.',
    params: {
      colorSpace: 'oklab',
      cellSize: 10,
      aspect: 0.25,
    ...
    seed: { kind: 'gradient', paletteId: 'evergreen', imageId: null },
  },
  {
    id: 'prism',
    name: 'Prism',
...
export const IMAGE_PRESETS: Preset[] = [
  {
    ...
    seed: { kind: 'image', paletteId: 'golden-hour', imageId: 'red-flowers' },
  },
  {
    id: 'melt',
    name: 'Melt',
    ...
    seed: { kind: 'image', paletteId: 'golden-hour', imageId: 'neon-street' },
  },
];
